    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <div className="ml-20 sm:ml-40 p-6">
        <header className="flex flex-col-reverse sm:flex-row justify-between items-center pb-6 border-b border-gray-700 gap-2">
          ...
          <div className="flex sm:items-center ml-[134px]  sm:ml-0 space-x-2 sm:space-x-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
            <div className="lg:col-span-2 flex flex-col bg-gray-800 p-4 rounded-lg">
              <div className="flex flex-row justify-between">
                ...
                <div className="px-4 py-[2px] border rounded-3xl text-stone-50 bg-slate-500 flex justify-center items-center flex-row gap-2 text text-[.9rem] sm:text-lg sm:leading-3">
                  Weekly <IoCaretDown />
                </div>
              </div>
